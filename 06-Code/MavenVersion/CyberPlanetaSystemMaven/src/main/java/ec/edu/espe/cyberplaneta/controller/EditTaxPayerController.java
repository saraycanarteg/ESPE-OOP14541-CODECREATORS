 ...
 */
public class EditTaxPayerController implements EditTaxPayerControllerInterface {

    @Override
    public void cargarTaxPayer(String id, JTextField txtEmail, JTextField txtNombre, JTextField txtContrasenia, JCheckBox chkDocumentacion, JDateChooser dateChooserStart, JDateChooser dateChooserEnd, JTextField txtCelular1) {
        if (id.isEmpty()) {
